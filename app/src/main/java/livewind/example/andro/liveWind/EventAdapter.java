...
public class EventAdapter extends ArrayAdapter<Event> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            if (event.getStartDate().equals(EventContract.EventEntry.IS_IT_EVENT) && displayBoolean ) {
                ...
                setupCoverage(view,event,windPowerUnit);
    ...
    private void setupCoverage(View view, Event event, int windPowerUnit){
    ...
    private void setupTrip(View view, Event event){
        //Init views
