...
class TripsDateDecreaseComparator implements Comparator<Event> {
    public int compare(Event trip1, Event trip2) {
        return trip2.startDateToGC().compareTo(trip1.startDateToGC());
    }
}
...
class TripsCostDescreaseComparator implements Comparator<Event> {
    ...
    public int compare(Event trip1, Event trip2) {
        ...
        return costWithCurrency2 - costWithCurrency1;
    }
}
/**
