package livewind.example.andro.liveWind.googlePay;
...
public class GooglePay {
    ...
    public static Optional<JSONObject> getPaymentDataRequest(String price) {
        try {
            ...
            paymentDataRequest.put("allowedPaymentMethods", new JSONArray().put(GooglePay.getCardPaymentMethod()));
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("totalPriceStatus", "FINAL");
        transactionInfo.put("currencyCode", livewind.example.andro.liveWind.googlePay.Constants.CURRENCY_CODE);
    ...
    /**
     * Converts micros to a string format accepted
     *
